...
### July 21, 2025 - Миграция в Replit завершена успешно и все баги исправлены + Минималистичный дизайн
- ✓ Создана новая база данных PostgreSQL с правильной схемой
- ✓ Исправлены ошибки в модели ShipmentOrder (корректные имена столбцов)
- ✓ Исправлены проблемы аутентификации в админ панели
- ✓ Добавлены правильные импорты PHP классов (PDO, Exception)
- ✓ Исправлены JavaScript ошибки в админ панели:
  - Добавлены функции toggleBulkActions и exportOrders
  - Исправлена ошибка FormData в экспорте
- ✓ Создан полноценный экспорт данных в Excel/CSV формате
- ✓ Добавлено поле стоимости отгрузки для каждого заказа с отображением в админ панели
- ✓ Изменен дизайн админ панели на минималистичный стиль:
  - Убраны градиенты и лишние цвета
  - Упрощены заголовки и навигация
  - Убраны эмодзи из интерфейса
  - Уменьшены отступы и размеры элементов
  - Использованы серые цвета вместо ярких
- ✓ Обновлен дашборд с минималистичным дизайном и графиками по ценам:
  - Добавлена статистика по выручке и ценам
  - График распределения цен по диапазонам
  - График доходов по дням за последние 7 дней
  - График средних цен по типам заказов
  - Минималистичный стиль во всех элементах
- ✓ Протестированы все основные функции:
  - Создание заказов по Астане - работает корректно ✅
  - Создание региональных заказов - форма доступна ✅
  - Админ аутентификация - функционирует правильно ✅
